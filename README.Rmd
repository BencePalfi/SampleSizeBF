...
## Features
  * Calculating Bayes factor with normal, Cauchy, and uniform distributions as a prior
  * Samplesize planning for Bayes factor using the same priors
  * Simulate samples to verify the results of the methods presented in the package
